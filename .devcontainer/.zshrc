...
if [[ -o interactive ]]; then
    ...
    eval "$(oh-my-posh init zsh --config https://gist.githubusercontent.com/joeblackwaslike/14cdef84a255b7560cb597a8d0e7b82e/raw/b860165acff4d600fd759d4fcea76d682c3b7ef0/theme.omp.yaml)"
fi
