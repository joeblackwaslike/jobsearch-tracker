...
describe('table-schemas', () => {
  ...
  describe('applicationTableSchema', () => {
    ...
    it('should have correct cell renderer for status', () => {
      ...
      expect(rendered).toEqual(
        <div data-testid="badge" data-variant={STATUS_COLORS.applied}>Applied</div>
      )
    })
    ...
    it('should have correct cell renderer for interest', () => {
      ...
      expect(rendered).toEqual(
        <div data-testid="badge" data-variant={INTEREST_COLORS.high}>High</div>
      )
    })
  ...
  describe('eventTableSchema', () => {
    ...
    it('should have correct cell renderer for status', () => {
      ...
      expect(rendered).toEqual(
        <div data-testid="badge" data-variant={EVENT_STATUS_COLORS.scheduled}>Scheduled</div>
      )
    })
  ...
  describe('capitalize helper', () => {
    it('should capitalize first letter of a string', () => {
      // This will be implemented in the table-schemas.ts file
