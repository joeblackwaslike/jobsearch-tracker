...
export function InterviewReminderEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Interview reminder: {interviewType} at {companyName} tomorrow
      </Preview>
      <Body style={{ backgroundColor: "#f5f5f5", fontFamily: "sans-serif" }}>
        ...
        >
          <Heading style={{ fontSize: "24px", marginBottom: "8px" }}>Interview Reminder</Heading>
          <Text>Hi {candidateName},</Text>
          <Text>You have an interview scheduled for tomorrow. Here are the details:</Text>
          <Section
            style={{
          ...
          <Text style={{ color: "#888888", fontSize: "12px" }}>
            You're receiving this because you have email reminders enabled in THRIVE. You can update
