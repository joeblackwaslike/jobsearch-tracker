...
out.push("DO $$");
out.push("DECLARE");
out.push("  v_user_id UUID := '00000000-0000-0000-0000-000000000001';");
out.push("BEGIN");
out.push("  -- Ensure a seed user exists in auth.users");
...
out.push("    is_super_admin, is_sso_user, is_anonymous");
out.push("  ) VALUES (");
out.push("    v_user_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',");
out.push("    'seed@example.com', crypt('password123', gen_salt('bf')),");
out.push("    NOW(), NOW(), NOW(),");
out.push("    '{\"provider\":\"email\",\"providers\":[\"email\"]}',");
out.push("    '{}',");
out.push("    false, false, false");
