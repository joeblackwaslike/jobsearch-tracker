...
BEGIN
  ...
  -- Disable event triggers during seeding (they would create duplicate events)
  ALTER TABLE applications DISABLE TRIGGER application_insert_event;
  ALTER TABLE applications DISABLE TRIGGER application_status_change_event;
  ...
  -- =========================================================
  INSERT INTO application_events_documents (id, application_id, document_id, name, type, content, uri, mime_type, revision)
  VALUES
  ...
  -- =========================================================
  -- USER_SETTINGS (ensure row exists for seed user)
  -- =========================================================
  ...
  -- USER_INTEGRATIONS
  -- =========================================================
  INSERT INTO user_integrations (id, user_id, provider, api_key, status)
  VALUES
    ('a0000001-0000-4000-8000-000000000001', v_user_id, 'anthropic', NULL, 'unconfigured'),
    ('a0000002-0000-4000-8000-000000000001', v_user_id, 'apollo', NULL, 'unconfigured'),
    ('a0000003-0000-4000-8000-000000000001', v_user_id, 'google', NULL, 'unconfigured'),
    ('a0000004-0000-4000-8000-000000000001', v_user_id, 'inngest', NULL, 'unconfigured')
  ON CONFLICT (id) DO NOTHING;

  -- =========================================================
  -- AI-GENERATED DOCUMENTS (must come before tasks that reference them)
  -- =========================================================
  INSERT INTO documents (id, user_id, name, type, content, uri, mime_type, revision, parent_id, tags, archived_at)
  VALUES
    (
      'dd000006-0000-4000-8000-000000000001', v_user_id,
      'TechCorp Inc — AI Company Research',
      'research',
      E'# TechCorp Inc — Company Research\n\n*Generated by AI on 2026-08-12*\n\n## Overview\n\nTechCorp Inc is a leading cloud infrastructure provider founded in 2010. The company specializes in scalable web applications and developer tooling, powering 40% of Fortune 500 developer workflows.\n\n## Key Insights\n\n- **Funding:** Series D, valued at $2.8B\n- **Engineering culture:** Remote-first, strong ownership model\n- **Tech stack:** React, TypeScript, Node.js, AWS, Kubernetes, PostgreSQL\n- **Interview focus:** Performance optimization, system design, component architecture\n\n## Preparation Notes\n\n- Review their blog post on distributed component caching\n- Prepare examples of performance optimization work\n- Understand their developer dashboard product deeply',
      NULL, NULL, '1',
      NULL,
      '["ai-generated","research","techcorp"]',
      NULL
    ),
    (
      'dd000007-0000-4000-8000-000000000001', v_user_id,
      'StartupXYZ — AI Company Research',
      'research',
      E'# StartupXYZ — Company Research\n\n*Generated by AI on 2026-08-12*\n\n## Overview\n\nStartupXYZ is an innovative fintech startup disrupting B2B payments with real-time settlement infrastructure. Series B funded, growing 3x year-over-year.\n\n## Key Insights\n\n- **Founders:** Ex-Stripe, deeply technical\n- **Team size:** 50-200 employees, 8-person engineering team\n- **Tech stack:** React, TypeScript, Node.js, GraphQL, PostgreSQL, Stripe, Kafka\n- **Interview focus:** Full-stack proficiency, PostgreSQL schema design, startup mindset\n\n## Preparation Notes\n\n- Research their payment settlement infrastructure\n- Prepare for live coding on their staging codebase\n- Understand GraphQL migration patterns they are planning',
      NULL, NULL, '1',
      NULL,
      '["ai-generated","research","startupxyz"]',
      NULL
    )
  ON CONFLICT (id) DO NOTHING;

  -- =========================================================
  -- TASKS (AI company research examples)
  -- =========================================================
  INSERT INTO tasks (id, user_id, application_id, type, status, payload, metadata, document_id)
  VALUES
    (
      'b0000001-0000-4000-8000-000000000001', v_user_id,
      'baffa47e-f414-4850-89f1-80467ea53046',
      'company_research', 'completed',
      '{"company_name":"TechCorp Inc","company_id":"ca7dd4f3-6f7d-4f46-8328-d8bf663448b5"}',
      '{"model":"claude-sonnet-4-20250514","tokens_used":2480}',
      'dd000006-0000-4000-8000-000000000001'
    ),
    (
      'b0000002-0000-4000-8000-000000000001', v_user_id,
      '85eb0794-443b-4af0-ae86-c341aca2c8db',
      'company_research', 'awaiting_approval',
      '{"company_name":"StartupXYZ","company_id":"29d82696-d691-49ec-bcd9-dc1a9c2aadcc"}',
      '{"model":"claude-sonnet-4-20250514","tokens_used":1920}',
      'dd000007-0000-4000-8000-000000000001'
    ),
    (
      'b0000003-0000-4000-8000-000000000001', v_user_id,
      'e7adb4ab-dba0-4500-924b-bfddb80c3aeb',
      'company_research', 'running',
      '{"company_name":"CloudScale Systems","company_id":"4769b594-1f5a-4207-8123-deea2272668d"}',
      '{}',
      NULL
    )
  ON CONFLICT (id) DO NOTHING;
  ...
  ALTER TABLE applications ENABLE TRIGGER application_insert_event;
  ALTER TABLE applications ENABLE TRIGGER application_status_change_event;
